...
namespace Bot.Builder.Community.Dialogs.Adaptive.Sql.Actions
{
    ...
    {
        [JsonProperty("$kind")]
        public const string DeclarativeType = "Community.SqlUpdateRow";
        ...
        public async override Task<DialogTurnResult> BeginDialogAsync(DialogContext dc, object options = null, CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                sqlResult.UpdatedRows = await connection.ExecuteAsync(sql, new DynamicParameters(paramList)).ConfigureAwait(false);
            }
            catch (Exception ex)
            {

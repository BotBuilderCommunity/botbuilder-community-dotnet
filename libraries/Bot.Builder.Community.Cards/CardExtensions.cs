...
namespace Bot.Builder.Community.Cards
{
    ...
    {
        public static BatchAndAttachmentsIds ApplyIdToBatch(this List<Activity> activities, IdOptions options = null)
        {
            ...
            if (activities.Any())
            {
                var attachmentsIds = new List<AttachmentsAndCardIds>();
                var batchId = IdType.Batch.ReplaceNullWithId(ref options);

                options.SetExistingId(IdType.Attachments);
                options.SetExistingId(IdType.Card);
                options.SetExistingId(IdType.Action);

                foreach (var activity in activities)
                {
                    var attachmentsId = activity.ApplyIdToAttachments(options);

                    if (attachmentsId != null)
                    {
                        attachmentsIds.Add(attachmentsId);
                    }
                }

                return new BatchAndAttachmentsIds(batchId, attachmentsIds);
            }

            return null;
        }

        public static AttachmentsAndCardIds ApplyIdToAttachments(this Activity activity, IdOptions options = null)
        {
            if (activity is null)
            {
            ...
            {
                var cardIds = new List<CardAndActionIds>();
                var attachmentsId = IdType.Attachments.ReplaceNullWithId(ref options);
                ...
                {
                    var cardId = attachment.ApplyId(options);
                ...
                return new AttachmentsAndCardIds(attachmentsId, cardIds);
            }

            return null;
        }

        public static CardAndActionIds ApplyId(this Attachment attachment, IdOptions options = null)
        {
        ...
        public static CardAndActionIds ApplyIdToAdaptiveCard(this JObject adaptiveCard, IdOptions options = null)
        {
            ...
            {
                var actionId = data.ApplyIdToPayload(options);
            ...
            return new CardAndActionIds(cardId, actionIds);
        }

        public static CardAndActionIds ApplyId(this AnimationCard card, IdOptions options = null)
        {
            if (card is null)
            {
        ...
        public static CardAndActionIds ApplyId(this AudioCard card, IdOptions options = null)
        {
            if (card is null)
            {
                throw new ArgumentNullException(nameof(card));
        ...
        public static CardAndActionIds ApplyId(this HeroCard card, IdOptions options = null)
        {
            if (card is null)
            {
                throw new ArgumentNullException(nameof(card));
        ...
        public static CardAndActionIds ApplyId(this OAuthCard card, IdOptions options = null)
        {
            if (card is null)
            {
                throw new ArgumentNullException(nameof(card));
        ...
        public static CardAndActionIds ApplyId(this ReceiptCard card, IdOptions options = null)
        {
            if (card is null)
            {
                throw new ArgumentNullException(nameof(card));
        ...
        public static CardAndActionIds ApplyId(this SigninCard card, IdOptions options = null)
        {
            if (card is null)
            {
                throw new ArgumentNullException(nameof(card));
        ...
        public static CardAndActionIds ApplyId(this ThumbnailCard card, IdOptions options = null)
        {
            if (card is null)
            {
                throw new ArgumentNullException(nameof(card));
        ...
        public static CardAndActionIds ApplyId(this VideoCard card, IdOptions options = null)
        {
            if (card is null)
            {
                throw new ArgumentNullException(nameof(card));
        ...
        public static CardAndActionIds ApplyId(this IList<CardAction> buttons, IdOptions options = null)
        {
            if (buttons is null)
            {
            ...
            foreach (var button in buttons)
            {
                ...
                {
                    var actionId = value.ApplyIdToPayload(options);

...
{
    public static class InfobipConstants
    {
        public const string HeaderSignatureKey = "x-hub-signature";
    }

    public static class InfobipAttachmentContentTypes
    {
        public const string WhatsAppMessageTemplate = "application/vhd.infobip.whatsapp-message-template";
    }

    public static class InfobipChannel
    {
        public const string WhatsApp = "infobip-whatsapp";
        public const string Sms = "infobip-sms";
    }

    public static class InfobipEntityType
    {
        public const string CallbackData = "application/vhd.infobip.callback-data";

...
namespace Bot.Builder.Community.Components.Handoff.Channel.Models
{
    ...
    public class Connection : IEquatable<Connection>
    {
        ...
        {
            return (other != null
                && ((ConversationReference1.Match(other.ConversationReference1)
                     && ConversationReference2.Match(other.ConversationReference2))
                     || (ConversationReference1.Match(other.ConversationReference2)
                         && ConversationReference2.Match(other.ConversationReference1))));
        }

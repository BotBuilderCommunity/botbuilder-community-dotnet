...
namespace Bot.Builder.Community.Components.Handoff.Channel.DataStore
{
    public interface IRoutingDataStore
    {
        ...
        IList<ConversationReference> GetHandoffChannels();

        /// <summary>
        /// Adds the given aggregation channel to the collection.
        /// </summary>
        /// <param name="conversationRefToAdd">The aggregation channel to add.</param>
        /// <returns>True, if successful. False otherwise.</returns>
        bool MakeConversationRefAvailableForHandoff(ConversationReference conversationRefToAdd);

        /// <summary>
        /// Removes the given aggregation channel from the collection.
        /// </summary>
        /// <param name="conversationRefToRemove">The aggregation channel to remove.</param>
        /// <returns>True, if successful. False otherwise.</returns>
        bool MakeConversationRefUnavailableForHandoff(ConversationReference conversationRefToRemove);

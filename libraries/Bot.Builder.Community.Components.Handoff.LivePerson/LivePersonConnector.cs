...
namespace Bot.Builder.Community.Components.Handoff.LivePerson
{
    ...
    static class LivePersonConnector
    {
        ...
        public static Message MakeLivePersonMessage(int id, string conversationId, string text)
        {
            return new Message
            {
                kind = "req",
        ...
        private static async Task<string> GetDomainAsync(string account, string serviceName)
        {
        ...
        private static async Task<string> GetAppJWTAsync(string account, string domain, string clientId, string clientSecret)
        {
            using (var client = new HttpClient())
            {
                var stringPayload = "";
        ...
        private static async Task<string> GetConsumerJWSAsync(string account, string domain, string authToken, ConsumerId consumer)
        {
            using (var client = new HttpClient())
            {
        ...
        private static async Task<string> StartConversationAsync(string account, string domain, string appJWT, string consumerJWS, Conversation[] conversations)
        {
            using (var client = new HttpClient())
            {
        ...
        public static async Task<int> SendMessageToConversationAsync(string account, string domain, string appJWT, string consumerJWS, Message message)
        {
            using (var client = new HttpClient())
            {

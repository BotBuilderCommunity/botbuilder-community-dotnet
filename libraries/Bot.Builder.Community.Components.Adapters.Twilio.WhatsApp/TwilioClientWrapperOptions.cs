...
namespace Bot.Builder.Community.Components.Adapters.Twilio.WhatsApp
{
    ...
    public class TwilioClientWrapperOptions
    {
        ...
        public TwilioClientWrapperOptions()
        {
        ...
        /// <param name="validateIncomingRequests">Validate Incoming Requests</param>
        public TwilioClientWrapperOptions(string twilioNumber, string twilioAccountSid, string twilioAuthToken, Uri twilioValidationUrl ,bool validateIncomingRequests)
        {
            ...
            ValidateIncomingRequests = validateIncomingRequests;
        }

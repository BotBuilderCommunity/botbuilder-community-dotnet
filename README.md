...
| [Infobip WhatsApp Adapter](libraries/Bot.Builder.Community.Adapters.Infobip) | An adapter that accepts and handles WhatsApp app requests via Infobip, including support for various message and template types. | | [![NuGet version](https://img.shields.io/badge/NuGet-blue.svg)](https://github.com/BotBuilderCommunity/botbuilder-community-dotnet/tree/develop/libraries/Bot.Builder.Community.Adapters.Infobip/) |

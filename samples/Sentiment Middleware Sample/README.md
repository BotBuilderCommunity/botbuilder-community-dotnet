...
## Visual Studio
- Open Sentiment_Middleware_Sample.csproj in Visual Studio.
...
- File -> Open bot and open [Sentiment_Middleware_Sample.bot](Sentiment_Middleware_Sample.bot).

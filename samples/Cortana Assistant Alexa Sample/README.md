# Cortana_Assistant_Alexa_Sample
...
## Visual Studio
- Open Cortana_Assistant_Alexa_Sample.csproj in Visual Studio.
...
- File -> Open bot and open [Cortana_Assistant_Alexa_Sample.bot](Cortana_Assistant_Alexa_Sample.bot).
